...
#define BFDEV_BITS_PER_U8           BFDEV_BITS_PER_TYPE(bfdev_u8)
#define BFDEV_BITS_PER_U16          BFDEV_BITS_PER_TYPE(bfdev_u16)
#define BFDEV_BITS_PER_U32          BFDEV_BITS_PER_TYPE(bfdev_u32)
#define BFDEV_BITS_PER_U64          BFDEV_BITS_PER_TYPE(bfdev_u64)
