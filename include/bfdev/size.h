...
#define BFDEV_SZ_1GiB       _BFDEV_AC(0x0010000000, ULL)
#define BFDEV_SZ_2GiB       _BFDEV_AC(0x0020000000, ULL)
#define BFDEV_SZ_4GiB       _BFDEV_AC(0x0040000000, ULL)
#define BFDEV_SZ_8GiB       _BFDEV_AC(0x0080000000, ULL)
#define BFDEV_SZ_16GiB      _BFDEV_AC(0x0100000000, ULL)
#define BFDEV_SZ_32GiB      _BFDEV_AC(0x0200000000, ULL)
#define BFDEV_SZ_64GiB      _BFDEV_AC(0x0400000000, ULL)
#define BFDEV_SZ_128GiB     _BFDEV_AC(0x0800000000, ULL)
#define BFDEV_SZ_256GiB     _BFDEV_AC(0x1000000000, ULL)
#define BFDEV_SZ_512GiB     _BFDEV_AC(0x2000000000, ULL)
