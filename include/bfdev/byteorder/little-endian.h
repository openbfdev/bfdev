...
#define bfdev_cpu_to_le16_const(x) ((__bfdev_force bfdev_le16)(bfdev_u16)(x))
#define bfdev_cpu_to_le32_const(x) ((__bfdev_force bfdev_le32)(bfdev_u32)(x))
#define bfdev_cpu_to_le64_const(x) ((__bfdev_force bfdev_le64)(bfdev_u64)(x))
#define bfdev_le16_to_cpu_const(x) ((__bfdev_force bfdev_u16)(bfdev_le16)(x))
#define bfdev_le32_to_cpu_const(x) ((__bfdev_force bfdev_u32)(bfdev_le32)(x))
#define bfdev_le64_to_cpu_const(x) ((__bfdev_force bfdev_u64)(bfdev_le64)(x))
...
#define bfdev_be16_to_cpu_const(x) bfdev_swab16_const((__bfdev_force bfdev_u16)(bfdev_be16)(x))
#define bfdev_be32_to_cpu_const(x) bfdev_swab32_const((__bfdev_force bfdev_u32)(bfdev_be32)(x))
#define bfdev_be64_to_cpu_const(x) bfdev_swab64_const((__bfdev_force bfdev_u64)(bfdev_be64)(x))

#define bfdev_cpu_to_le16(x) ((__bfdev_force bfdev_le16)(bfdev_u16)(x))
#define bfdev_cpu_to_le32(x) ((__bfdev_force bfdev_le32)(bfdev_u32)(x))
#define bfdev_cpu_to_le64(x) ((__bfdev_force bfdev_le64)(bfdev_u64)(x))
#define bfdev_le16_to_cpu(x) ((__bfdev_force bfdev_u16)(bfdev_le16)(x))
#define bfdev_le32_to_cpu(x) ((__bfdev_force bfdev_u32)(bfdev_le32)(x))
#define bfdev_le64_to_cpu(x) ((__bfdev_force bfdev_u64)(bfdev_le64)(x))
...
#define bfdev_be16_to_cpu(x) bfdev_swab16((__bfdev_force bfdev_u16)(bfdev_be16)(x))
#define bfdev_be32_to_cpu(x) bfdev_swab32((__bfdev_force bfdev_u32)(bfdev_be32)(x))
#define bfdev_be64_to_cpu(x) bfdev_swab64((__bfdev_force bfdev_u64)(bfdev_be64)(x))
