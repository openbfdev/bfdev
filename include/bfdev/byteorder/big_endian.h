...
#define bfdev_htons_constant(x) ((bfdev_be16)(uint16_t)(x))
#define bfdev_htonl_constant(x) ((bfdev_be32)(uint32_t)(x))
#define bfdev_ntohl_constant(x) ((uint32_t)(bfdev_be32)(x))
#define bfdev_ntohs_constant(x) ((uint16_t)(bfdev_be16)(x))

#define bfdev_cpu_to_le16_constant(x) ((bfdev_le16)bfdev_swab16_constant((x)))
#define bfdev_cpu_to_le32_constant(x) ((bfdev_le32)bfdev_swab32_constant((x)))
#define bfdev_cpu_to_le64_constant(x) ((bfdev_le64)bfdev_swab64_constant((x)))
#define bfdev_le16_to_cpu_constant(x) bfdev_swab16_constant((uint16_t)(bfdev_le16)(x))
#define bfdev_le32_to_cpu_constant(x) bfdev_swab32_constant((uint32_t)(bfdev_le32)(x))
#define bfdev_le64_to_cpu_constant(x) bfdev_swab64_constant((uint64_t)(bfdev_le64)(x))

#define bfdev_cpu_to_be16_constant(x) ((bfdev_be16)(uint16_t)(x))
#define bfdev_cpu_to_be32_constant(x) ((bfdev_be32)(uint32_t)(x))
#define bfdev_cpu_to_be64_constant(x) ((bfdev_be64)(uint64_t)(x))
#define bfdev_be16_to_cpu_constant(x) ((uint16_t)(bfdev_be16)(x))
#define bfdev_be32_to_cpu_constant(x) ((uint32_t)(bfdev_be32)(x))
#define bfdev_be64_to_cpu_constant(x) ((uint64_t)(bfdev_be64)(x))
