...
#define bfdev_ntohl_const(x) bfdev_swab32_const((bfdev_be32)(x))
#define bfdev_ntohs_const(x) bfdev_swab16_const((bfdev_be16)(x))

#define bfdev_cpu_to_le16_const(x) ((bfdev_le16)(uint16_t)(x))
#define bfdev_cpu_to_le32_const(x) ((bfdev_le32)(uint32_t)(x))
#define bfdev_cpu_to_le64_const(x) ((bfdev_le64)(uint64_t)(x))
#define bfdev_le16_to_cpu_const(x) ((uint16_t)(bfdev_le16)(x))
#define bfdev_le32_to_cpu_const(x) ((uint32_t)(bfdev_le32)(x))
#define bfdev_le64_to_cpu_const(x) ((uint64_t)(bfdev_le64)(x))

#define bfdev_cpu_to_be16_const(x) ((bfdev_be16)bfdev_swab16_const((x)))
#define bfdev_cpu_to_be32_const(x) ((bfdev_be32)bfdev_swab32_const((x)))
#define bfdev_cpu_to_be64_const(x) ((bfdev_be64)bfdev_swab64_const((x)))
#define bfdev_be16_to_cpu_const(x) bfdev_swab16_const((uint16_t)(bfdev_be16)(x))
#define bfdev_be32_to_cpu_const(x) bfdev_swab32_const((uint32_t)(bfdev_be32)(x))
#define bfdev_be64_to_cpu_const(x) bfdev_swab64_const((uint64_t)(bfdev_be64)(x))
