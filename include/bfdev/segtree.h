...
extern void bfdev_segtree_insert(struct bfdev_rb_root_cached *root, bfdev_segtree_node_t *node);
extern void bfdev_segtree_delete(struct bfdev_rb_root_cached *root, bfdev_segtree_node_t *node);
extern bfdev_segtree_node_t *bfdev_segtree_search(bfdev_segtree_node_t *node, unsigned long start, unsigned long end);
extern bfdev_segtree_node_t *bfdev_segtree_first(struct bfdev_rb_root_cached *root, unsigned long start, unsigned long end);
