...
# define BFDEV_POISON_OFFSET _AC(BFDEV_POISON_ILLEGAL_ADDRESS, UL)
#else
...
#define BFDEV_POISON_BINTREE1   ((void *) (BFDEV_POISON_OFFSET + 0x500))
#define BFDEV_POISON_BINTREE2   ((void *) (BFDEV_POISON_OFFSET + 0x510))
#define BFDEV_POISON_BINTREE3   ((void *) (BFDEV_POISON_OFFSET + 0x520))
